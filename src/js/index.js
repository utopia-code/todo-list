import { onLoadEventHandler, newTodoEventHandler, removeTodoEventHandler, toogleTodoEventListener, confirmRemoveEventHandler } from './event-handlers'; 
import $ from 'jquery';
...
$(document).on('click', '.real-checkbox', toogleTodoEventListener);
